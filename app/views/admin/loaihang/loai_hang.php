        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <form class="col-lg-12 mx-auto py-1" action="insert_loai" method="POST" name="loaihang">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ten_loai" name="ten_loai" placeholder="nhập vào tên loại">
                        </div>
                        <button class="btn btn-primary" type="submit">Thêm vào</button>
                        <a class="btn btn-primary" href="danh_sach_loai" role="button">Danh sách</a>
